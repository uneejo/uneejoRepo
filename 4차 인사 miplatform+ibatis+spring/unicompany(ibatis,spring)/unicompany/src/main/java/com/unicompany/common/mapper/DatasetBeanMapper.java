package com.unicompany.common.mapper;
...
import com.unicompany.common.annotation.Column;
...
public class DatasetBeanMapper {
    ...
    private <T> String getDatasetName(Class<T> classType) {
        ...
        return classType.getAnnotation(com.unicompany.common.annotation.Dataset.class).name();
    }
