...
public class BasicEmployeeController extends AbstractMiplatformMultiActionController {
	...
	public void pdfSend(PlatformData inData, PlatformData outData) throws Exception  {
	      ...
	      String templatePath = "E:/miplatformpj/unicompany/src/main/webapp/report/empPdf.jrxml";
	       // 출력할 PDF 파일 경로
	      String destPath = "E:/miplatformpj/unicompany/src/main/webapp/report/"+sEmpCode+".pdf";
	      Connection con = null;
	      try {
	      //템플레이트 XML 컴파일
	      ...
	      con = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521/xe", "insaa","insaa");
	      //데이타의 동적 바인드
	...
	public void sendEmail(PlatformData inData, PlatformData outData) throws Exception {
	      ...
	      // 메일 관련 정보
	         ...
	         String filename = "C:/apache2.2/htdocs/unicompany/report/"+empCode+".pdf";
	         //첨부할 파일 경로
